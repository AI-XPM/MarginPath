...
# Raw Image Data
To protect patient privacy, only a portion of the data has been processed and made publicly available. Additional data is available from the corresponding author upon reasonable request.
